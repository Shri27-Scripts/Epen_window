...
public class SubjectsPage {
	...
	@FindBy(xpath = "//*[@ClassName='TextEdit' and @AutomationId='dtxtDisplayCode']")
	...
	@FindBy(xpath = "//*[@AutomationId='DX$CheckboxSelectorColumn' and @Name='Unchecked, Item: ePen.Admin.Models.qvwSubject, Column Display Index: 0']")
	private WebElement Checkbox;
	
	@FindBy(xpath = "//*[@Name='Delete' and @ClassName='Button']")
	private WebElement Delete;
	
	@FindBy(xpath = "//*[@Name='ATD-012, Item: ePen.Admin.Models.qvwSubject, Column Display Index: 1' and @AutomationId='Code']")
	private WebElement EditSubject;
	
	@FindBy(xpath = "//*[@Name='Close' and @ClassName='Button']")
	private WebElement CloseWindow;
	
	public SubjectsPage(WiniumDriver driver) {
	...
	public WebElement getDisplayCode() {
		return DisplayCode;
	}
