...
public class ValuationTypesPage {
	...
	@FindBy(xpath = "//*[@ClassName='ComboBoxEdit' and @AutomationId='dcmbProcessType']")
	private WebElement ProcessType;
	
	@FindBy(xpath = "//*[@ClassName='LookUpEdit' and @AutomationId='dlkupExaminations']")
	...
	@FindBy(xpath = "//*[@AutomationId='DX$CheckboxSelectorColumn' and @Name='Unchecked, Item: ePen.Admin.Models.qvwValuationType, Column Display Index: 0']")
	private WebElement Checkbox;
	
	@FindBy(xpath = "//*[@Name='Delete' and @ClassName='Button']")
	private WebElement Delete;
	
	@FindBy(xpath = "//*[@Name='HAX7R, Item: ePen.Admin.Models.qvwValuationType, Column Display Index: 1' and @AutomationId='Code']")
	private WebElement EditValuationType;
	
	@FindBy(xpath = "//*[@Name='Close' and @ClassName='Button']")
	private WebElement CloseWindow;
	
	public ValuationTypesPage(WiniumDriver driver) {
	...
	public WebElement getProcessType() {
		return ProcessType; 
	}
	...
	public WebElement getEdit_ValuationType() {
		return EditValuationType; 
	}
