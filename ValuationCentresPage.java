...
public class ValuationCentresPage {
	...
	@FindBy(xpath = "//*[@AutomationId='DX$CheckboxSelectorColumn' and @Name='Unchecked, Item: ePen.Admin.Models.qvwValuationCentre, Column Display Index: 0']")
	private WebElement Checkbox;
	
	@FindBy(xpath = "//*[@Name='Delete' and @ClassName='Button']")
	private WebElement Delete;
	
	@FindBy(xpath = "//*[@Name='HAX8P, Item: ePen.Admin.Models.qvwValuationCentre, Column Display Index: 1' and @AutomationId='Code']")
	private WebElement EditValuationCentre;
	
	@FindBy(xpath = "//*[@Name='Close' and @ClassName='Button']")
	private WebElement CloseWindow;
	
	public ValuationCentresPage(WiniumDriver driver) {
	...
	public WebElement getEdit_ValuationCentre() {
		return EditValuationCentre; 
	}
