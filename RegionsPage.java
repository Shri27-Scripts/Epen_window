...
public class RegionsPage {
	...
	@FindBy(xpath = "//*[@AutomationId='DX$CheckboxSelectorColumn' and @Name='Unchecked, Item: ePen.Admin.Models.qvwRegion, Column Display Index: 0']")
	private WebElement Checkbox;
	
	@FindBy(xpath = "//*[@Name='Delete' and @ClassName='Button']")
	private WebElement Delete;
	
	@FindBy(xpath = "//*[@Name='HAX5B, Item: ePen.Admin.Models.qvwRegion, Column Display Index: 1' and @AutomationId='Code']")
	private WebElement EditRegion;
	
	@FindBy(xpath = "//*[@Name='Close' and @ClassName='Button']")
	private WebElement CloseWindow;
	
	public RegionsPage(WiniumDriver driver) {
	...
	public WebElement getEditRegions() {
		return EditRegion; 
	}
